<?php
/**
 * Food Preset Redux Configuration
 * 
 * Header and Footer settings for Food preset
 * 
 * @package AlOmran
 * @subpackage Food
 */
...
if (class_exists('Redux')) {
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'food_header_logo_show_title',
                'type'     => 'switch',
            ...
            array(
                'id'       => 'food_header_logo_title',
                'type'     => 'text',
                'title'    => __('عنوان الشعار', 'alomran'),
                'subtitle' => __('أدخل العنوان الذي سيظهر بجانب الشعار (اتركه فارغاً لاستخدام اسم الشركة من الإعدادات العامة)', 'alomran'),
                'default'  => '',
                'required' => array('food_header_logo_show_title', '=', true),
            ),
            array(
                'id'       => 'food_header_logo_show_subtitle',
                'type'     => 'switch',
            ...
            array(
                'id'       => 'food_header_logo_subtitle',
                'type'     => 'text',
                'title'    => __('العنوان الثانوي', 'alomran'),
                'subtitle' => __('أدخل العنوان الثانوي الذي سيظهر تحت العنوان (اتركه فارغاً لاستخدام شعار الشركة من الإعدادات العامة)', 'alomran'),
                'default'  => '',
                'required' => array('food_header_logo_show_subtitle', '=', true),
            ),
            ...
            // ============================================
            array(
                'id'       => 'food_header_colors_section',
                'type'     => 'section',
                'title'    => __('ألوان الهيدر', 'alomran'),
                'indent'   => true,
            ),
            array(
                'id'       => 'food_header_bg_color',
                'type'     => 'color',
            ...
            array(
                'id'       => 'food_header_link_hover_color',
                'type'     => 'color',
