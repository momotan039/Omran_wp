...
// Return array of section files to load for Food preset
...
return array(
    ...
    'food-contact-page.php',   // Contact page settings (subsection) - Food preset specific
