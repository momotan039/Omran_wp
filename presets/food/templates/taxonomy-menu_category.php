<?php
/**
 * Food Preset - Menu Category Taxonomy Template
...
// Get menu settings from Redux
$menu_title = $category_name; // Use category name as title
$menu_description = !empty($category_description) ? $category_description : 'كل طبق هو رحلة عبر الزمن، محضرة بأفضل المكونات الموسمية والتقنيات العصرية.';
...
<div class="pt-40 pb-20 bg-brand-cream min-h-screen">
    <div class="max-w-4xl mx-auto px-8 text-center">
        <h1 class="text-7xl font-black mb-12"><?php echo esc_html($category_name); ?></h1>
        <?php if (!empty($category_description)): ?>
            <p class="text-brand-gray text-xl max-w-2xl mx-auto mb-12"><?php echo esc_html($category_description); ?></p>
        <?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <?php else: ?>
                    <div class="col-span-full text-center text-gray-500 py-12">
                        <p>لا توجد أصناف متاحة في هذه الفئة حالياً.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
