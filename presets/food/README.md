...
The Food preset is a complete, self-contained theme preset designed for restaurants, cafes, and food businesses. It includes all necessary templates, assets, Redux configurations, and demo content.
...
- **Content Isolation**: When a preset is active, only content from that preset is shown. Content from other presets is automatically hidden. When importing demo content for a new preset, content from other presets is automatically deleted to ensure a clean site.
