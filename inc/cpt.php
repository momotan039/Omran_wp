<?php
/**
 * Industrial Theme - Custom Post Types
 * 
 * @package AlOmran
...
/**
 * Register Industrial theme CPTs
 */
function alomran_industrial_register_post_types() {
    register_post_type(
        'product',
        array(
            'labels' => array(
 ...
 */
function alomran_industrial_flush_rewrite_rules() {
    flush_rewrite_rules(false);
}
add_action('after_switch_theme', 'alomran_industrial_flush_rewrite_rules');
