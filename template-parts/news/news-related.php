    ...
    <div class="container mx-auto px-4 mt-12 mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <?php while ($related_news->have_posts()) : $related_news->the_post(); ?>
                <a href="<?php the_permalink(); ?>" class="group block bg-gray-50 rounded-lg overflow-hidden hover:shadow-md transition">
                    ...
                    <?php endif; ?>
                    <div class="p-4">
                        <span class="text-xs text-secondary font-bold"><?php echo get_the_date(); ?></span>
                        <h4 class="font-bold text-gray-800 mt-1 group-hover:text-primary transition"><?php the_title(); ?></h4>
                    </div>
                </a>
            <?php endwhile; ?>
        </div>
