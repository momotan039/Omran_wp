...
$header_classes = array('z-50', 'shadow-sm', 'border-b');
...
if ($header_bg_color) {
    ...
    $header_style .= 'background-color: var(--theme-white); ';
}

if ($header_text_color) {
    $header_style .= 'color: ' . esc_attr($header_text_color) . '; ';
} else {
    $header_style .= 'color: var(--theme-gray-900); ';
}

if ($header_border_color) {
    $header_style .= 'border-color: ' . esc_attr($header_border_color) . '; ';
} else {
    $header_style .= 'border-color: var(--theme-gray-200); ';
