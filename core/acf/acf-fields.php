...
if (function_exists('acf_add_local_field_group')) {
     ...
     * 
     * @hook omran_core_acf_fields_registered
     */
    function omran_core_register_acf_fields() {
        ...
        /**
         * Action fired after ACF fields are registered.
         * 
         * @since 1.0.0
         */
        do_action('omran_core_acf_fields_registered');
    }
    // Register fields on both acf/init and init hooks for better compatibility
    add_action('acf/init', 'omran_core_register_acf_fields');
    add_action('init', 'omran_core_register_acf_fields', 20);
    
    // Backward compatibility
    if (!function_exists('alomran_register_acf_fields')) {
        function alomran_register_acf_fields() {
            omran_core_register_acf_fields();
        }
    }
}
