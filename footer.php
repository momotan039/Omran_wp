        ...
        <footer class="<?php echo esc_attr($footer_class); ?>">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                <div class="md:col-span-1">
                    <h3 class="text-2xl font-bold text-white mb-4"><?php echo esc_html($company_info['name']); ?></h3>
                    <?php if (!empty($footer_data['description'])) : ?>
                    <p class="mb-6 leading-relaxed text-sm text-gray-400">
                    ...
                    <?php if (!empty($footer_data['social_enable']) && !empty($footer_data['social_links'])) : ?>
                        <div class="flex space-x-4 space-x-reverse flex-wrap gap-3">
                            <?php if (!empty($footer_data['social_links']['facebook'])) : ?>
                                <a href="<?php echo esc_url($footer_data['social_links']['facebook']); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all duration-300" aria-label="<?php esc_attr_e('Facebook', 'alomran'); ?>">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                            <?php endif; ?>
                            <?php if (!empty($footer_data['social_links']['linkedin'])) : ?>
                                <a href="<?php echo esc_url($footer_data['social_links']['linkedin']); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all duration-300" aria-label="<?php esc_attr_e('LinkedIn', 'alomran'); ?>">
                            ...
                            <?php if (!empty($footer_data['social_links']['instagram'])) : ?>
                                <a href="<?php echo esc_url($footer_data['social_links']['instagram']); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all duration-300" aria-label="<?php esc_attr_e('Instagram', 'alomran'); ?>">
                            ...
                            <?php if (!empty($footer_data['social_links']['twitter'])) : ?>
                                <a href="<?php echo esc_url($footer_data['social_links']['twitter']); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all duration-300" aria-label="<?php esc_attr_e('Twitter', 'alomran'); ?>">
                            ...
                            <?php if (!empty($footer_data['social_links']['youtube'])) : ?>
                                <a href="<?php echo esc_url($footer_data['social_links']['youtube']); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all duration-300" aria-label="<?php esc_attr_e('YouTube', 'alomran'); ?>">
                            ...
                            <?php if (!empty($footer_data['social_links']['whatsapp'])) : ?>
                                <a href="<?php echo esc_url($footer_data['social_links']['whatsapp']); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all duration-300" aria-label="<?php esc_attr_e('WhatsApp', 'alomran'); ?>">
                ...
                <div>
                    <h4 class="text-white font-bold text-lg mb-4 border-b-2 border-secondary w-fit pb-1"><?php esc_html_e('منتجاتنا', 'alomran'); ?></h4>
                    <?php
                ...
                <div>
                    <h4 class="text-white font-bold text-lg mb-4 border-b-2 border-secondary w-fit pb-1"><?php esc_html_e('تواصل معنا', 'alomran'); ?></h4>
            ...
            <div class="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 gap-4">
                ...
                <p class="flex items-center gap-1">
                    ...
                    <a href="https://mohamad-taha.com/" target="_blank" rel="noopener noreferrer" class="text-secondary hover:text-white transition-colors font-bold">
                        محمد طه
                    </a>
                </p>
            </div>
