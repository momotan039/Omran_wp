    ...
    <div class="container mx-auto px-4">
        <?php if (have_posts()) : ?>
            <div class="text-center mb-12 animate-fade-in-up">
                <h1 class="text-4xl font-bold text-primary mb-4">
                    ...
                    if (is_home() && !is_front_page()) {
                        ...
                        esc_html_e('Latest Posts', 'alomran-food');
                    }
                    ?>
                </h1>
            </div>
                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class('bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 animate-fade-in-up'); ?>>
                        ...
                        <div class="p-6">
                            ...
                            <a href="<?php the_permalink(); ?>" class="text-secondary font-bold text-sm hover:underline inline-flex items-center gap-1">
                                <?php esc_html_e('اقرأ المزيد', 'alomran-food'); ?>
            ...
            the_posts_pagination(
                array(
                    'mid_size'  => 2,
                    'prev_text' => __('&laquo; السابق', 'alomran-food'),
                    'next_text' => __('التالي &raquo;', 'alomran-food'),
                )
            );
            ?>
        ...
        <?php else : ?>
            <div class="text-center py-20 animate-fade-in-up">
                <h2 class="text-2xl font-bold text-gray-500 mb-4"><?php esc_html_e('لا توجد منشورات', 'alomran-food'); ?></h2>
                <p class="text-gray-400"><?php esc_html_e('لم يتم العثور على أي محتوى.', 'alomran-food'); ?></p>
            </div>
        <?php endif; ?>
    </div>
</div>
